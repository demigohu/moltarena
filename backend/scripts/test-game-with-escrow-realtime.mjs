...
/** Kontrak memakai tinybar; JSON-RPC `value` deposit = tinybar * 10^10. Lihat docs Hedera decimal handling. */
...
/** Nilai `value` untuk writeContract: matches.wagerAmount (tinybar) * 10^10. */
